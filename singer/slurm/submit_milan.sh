#!/bin/bash
# Submit singer runs as a SLURM array on extended-96core-shared (Milan).
# Each array task runs snakemake for one row of the params CSV.
# Usage: bash submit_milan.sh [start] [end]
#   defaults: 1 700
...
PARTITION="extended-96core-shared"
MAX_TIME="48:00:00"
MEM="2G"
CPUS=1
