#!/bin/bash
# Submit a singer chunk to hbm-extended-96core (dedicated, 48h limit).
# Snakemake runs up to 96 jobs in parallel internally.
# Usage: bash submit_hbm_extended96.sh <chunk_csv>
# Example: bash submit_hbm_extended96.sh slurm/chunks/chunk4.csv
