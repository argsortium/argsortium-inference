#!/bin/bash
# Submit singer runs as a SLURM array on extended-96core-shared (Milan, 3.5d limit).
# Each array task runs snakemake for one row of the params CSV.
# Usage: bash submit_extended96.sh [start] [end]
# Will initialize end - start number of jobs
#   defaults: 292 501 
